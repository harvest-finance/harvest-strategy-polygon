...
contract QuickStrategyMainnet_MATIC_ETH is SNXRewardUniLPStrategy {

  address public eth = address(0x7ceB23fD6bC0adD59E62ac25578270cFf1b9f619);
  address public wmatic_eth = address(0xadbF1854e5883eB8aa7BAf50705338739e558E5b);
  ...
  SNXRewardUniLPStrategy(_storage, wmatic_eth, _vault, SNXRewardPool, quick, routerAddress)
  public {
    require(IVault(_vault).underlying() == wmatic_eth, "Underlying mismatch");
