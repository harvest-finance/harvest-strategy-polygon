...
const Strategy = artifacts.require("CurveStrategyEurtusdMainnet");
const IDeposit = artifacts.require("ICurveDeposit_4token");

// test run with block number: 25091822

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Polygon Mainnet Curve eurtusd", function() {
  let accounts;
  ...
  let depositAddr = "0x225FB4176f0E20CDb66b4a3DF70CA3063281E855";
  let deposit;
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0x600743B1d8A96438bD46836fD34977a00293f6Aa");
    console.log("Fetching Underlying at: ", underlying.address);
  }

  async function setupBalance(){
    token1 = await IERC20.at(dai);
    ...
    await deposit.add_liquidity([0, farmerToken1Balance, 0, 0], 0, {from:farmer1});
