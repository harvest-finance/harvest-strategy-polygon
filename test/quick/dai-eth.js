...
const Strategy = artifacts.require("QuickStrategyMainnet_DAI_ETH");


// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Polygon Mainnet Quickswap DAI/ETH", function() {
  let accounts;
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0x4A35582a710E1F4b2030A3F826DA20BfB6703C09");
