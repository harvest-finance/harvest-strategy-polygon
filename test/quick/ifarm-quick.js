...
const Strategy = artifacts.require("QuickStrategyMainnet_iFARM_QUICK");


// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Polygon Mainnet Quickswap iFARM/QUICK", function() {
  let accounts;
  ...
  // external setup
  let token0Addr = "0x831753DD7087CaC61aB5644b308642cc1c33Dc13"; //quick
  let token1Addr = "0xab0b2ddB9C7e440fAc8E140A89c0dbCBf2d7Bbff"; //ifarm
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0xD7668414BfD52DE6d59E16e5f647c9761992C435");
  ...
  async function setupBalance(){
    ...
    console.log(new BigNumber(farmerToken0Balance).toFixed());
    console.log(new BigNumber(farmerToken1Balance).toFixed());
