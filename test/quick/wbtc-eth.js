...
const Strategy = artifacts.require("QuickStrategyMainnet_WBTC_ETH");


// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Polygon Mainnet Quickswap WBTC/ETH", function() {
  let accounts;
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0xdC9232E2Df177d7a12FdFf6EcBAb114E2231198D");
