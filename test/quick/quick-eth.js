...
const Strategy = artifacts.require("QuickStrategyMainnet_QUICK_ETH");


// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Polygon Mainnet Quickswap QUICK/ETH", function() {
  let accounts;
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0x1Bd06B96dd42AdA85fDd0795f3B4A79DB914ADD5");
