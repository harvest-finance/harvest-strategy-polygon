...
const Strategy = artifacts.require("QuickStrategyMainnet_USDC_USDT");


// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Polygon Mainnet Quickswap USDC/USDT", function() {
  let accounts;
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0x2cF7252e74036d1Da831d11089D326296e64a728");
