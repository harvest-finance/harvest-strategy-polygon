...
const Strategy = artifacts.require("JarvisHodlStrategyV3Mainnet_jCHF_USDC");
...
describe("Mainnet Jarvis jCHF-USDC HODL in LP V3", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0x32241c3ACf2a121Ab8C9138562E15d4FE9e95067";
  ...
  before(async function() {
    ...
    [controller, vault, strategy, potPool] = await setupCoreProtocol({
      "existingVaultAddress": "0x7f316D2498a234670554D1a890a364b0bD9d88e2",
      "existingRewardPoolAddress": "0x24Aa3547962872351c30F1127430172317C05FEC",
  ...
  describe("Happy path", function() {
    it("Farmer should earn money", async function() {
      ...
      for (let i = 0; i < hours; i++) {
        ...
        lpPrice = new BigNumber(20884964).times(D18);
