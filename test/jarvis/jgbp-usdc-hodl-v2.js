...
const Strategy = artifacts.require("JarvisHodlStrategyMainnet_jGBP_USDC_V2");
...
describe("Mainnet Jarvis jGBP-USDC HODL in LP V2", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0x7432b5212F19af018b33b73a55d1996960E59c51";
  ...
  describe("Happy path", function() {
    it("Farmer should earn money", async function() {
      ...
      for (let i = 0; i < hours; i++) {
        ...
        lpPrice = new BigNumber(2308077.93).times(D18);
