...
const Strategy = artifacts.require("JarvisHodlStrategyV3Mainnet_jCHF_WETH");

const D18 = new BigNumber(Math.pow(10, 18));

//This test was developed at blockNumber 28954350

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Mainnet Jarvis jCHF-WETH HODL in LP", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0xC62B08a5Ac22b4dE931a3BDb21101DAfDB9ad3d7";
  let hodlVaultAddr = "0x3BB93BdEaF0906819e5D2Eccdc2E9Ce408296dD1";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0x95697B1b83E0F28017158BF2a2Adc6bA991088EC");
  ...
  describe("Happy path", function() {
    it("Farmer should earn money", async function() {
      ...
      for (let i = 0; i < hours; i++) {
        ...
        hodlPrice = new BigNumber(1720.75).times(D18);
        lpPrice = new BigNumber(88.527).times(D18);
