...
const HodlStrategy = artifacts.require("JarvisStrategyV3Mainnet_QUI_2CAD");
const Strategy = artifacts.require("JarvisHodlStrategyV3Mainnet_2CAD");

const D18 = new BigNumber(Math.pow(10, 18));

//This test was developed at blockNumber 23993309

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Mainnet Jarvis 2CAD HODL in LP", function() {
  let accounts;
  ...
  describe("Happy path", function() {
    it("Farmer should earn money", async function() {
      ...
      let farmerOldfQUI_2CAD = new BigNumber(await hodlVault.balanceOf(farmer1));
      ...
      for (let i = 0; i < hours; i++) {
        ...
        console.log("fQUI-2CAD in potpool: ", newPotPoolBalance.toFixed());
      ...
      let farmerNewfQUI_2CAD = new BigNumber(await hodlVault.balanceOf(farmer1));
      Utils.assertBNGte(farmerNewBalance, farmerOldBalance);
      Utils.assertBNGt(farmerNewfQUI_2CAD, farmerOldfQUI_2CAD);

      oldValue = (fTokenBalance.times(1e18).times(lpPrice)).div(1e36);
      newValue = (fTokenBalance.times(newSharePrice).times(lpPrice)).div(1e36).plus((farmerNewfQUI_2CAD.times(newHodlSharePrice).times(hodlPrice)).div(1e36));
      ...
      console.log("fQUI-2CAD in potpool: ", (new BigNumber(await hodlVault.balanceOf(potPool.address))).toFixed() );
      console.log("Farmer got fQUI-2CAD from potpool: ", farmerNewfQUI_2CAD.toFixed());
      console.log("earned!");
