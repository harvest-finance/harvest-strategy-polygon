...
const Strategy = artifacts.require("JarvisHodlStrategyV3Mainnet_jEUR_WETH");
...
describe("Mainnet Jarvis jEUR-WETH HODL in LP", function() {
  let accounts;
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0x7090f6f42EA9b07C85E46aD796f8C4A50E0f76fA");
  ...
  describe("Happy path", function() {
    it("Farmer should earn money", async function() {
      ...
      for (let i = 0; i < hours; i++) {
        ...
        lpPrice = new BigNumber(89.83).times(D18);
