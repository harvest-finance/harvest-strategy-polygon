...
const Strategy = artifacts.require("JarvisHodlStrategyMainnet_jCHF_USDC_V2");
...
describe("Mainnet Jarvis jCHF-USDC HODL in LP V2", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0x45f5288431D6E480535901196491F9f9554AD38D";
  ...
  describe("Happy path", function() {
    it("Farmer should earn money", async function() {
      ...
      for (let i = 0; i < hours; i++) {
        ...
        lpPrice = new BigNumber(2080964.06).times(D18);
