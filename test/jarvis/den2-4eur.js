...
const Strategy = artifacts.require("JarvisStrategyV3Mainnet_DEN2_4EUR");

//This test was developed at blockNumber 24115800

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Mainnet Jarvis DEN2-4EUR", function() {
  let accounts;
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0xEb6f426963140471a7c1E4337877e6dBf834d2A8");
