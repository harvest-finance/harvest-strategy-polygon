...
const HodlStrategy = artifacts.require("JarvisStrategyMainnet_AUR_USDC_V2");
const Strategy = artifacts.require("JarvisHodlStrategyMainnet_jEUR_USDC_V2");
...
describe("Mainnet Jarvis jEUR-USDC HODL in LP V2", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0x225509847509f66c9bd49cdA9714F481a3a6200E";
  let hodlUnderlying = "0xA623aacf9eB4Fc0a29515F08bdABB0d8Ce385cF7";
  ...
  describe("Happy path", function() {
    it("Farmer should earn money", async function() {
      ...
      for (let i = 0; i < hours; i++) {
        ...
        hodlPrice = new BigNumber(94855051.49).times(D18);
        lpPrice = new BigNumber(2126959.39).times(D18);
