...
const Strategy = artifacts.require("JarvisHodlStrategyV3Mainnet_2EUR_EURe");

const D18 = new BigNumber(Math.pow(10, 18));

//This test was developed at blockNumber 33304950

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Mainnet Jarvis 2EUR-EURe HODL in LP", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0x476e23bFc5415397021a74e525640b328A12b81e";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0x2F3E9CA3bFf85B91D9fe6a9f3e8F9B1A6a4c3cF4");
  ...
  describe("Happy path", function() {
    it("Farmer should earn money", async function() {
      ...
      for (let i = 0; i < hours; i++) {
        ...
        lpPrice = new BigNumber(1.00).times(D18);
