...
const Strategy = artifacts.require("JarvisHodlStrategyMainnet_jGBP_USDC");
...
describe("Mainnet Jarvis jGBP-USDC HODL in LP", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0x20DfeEd4bD0a027b31240a25Dd257E85A42bFFaf";
  ...
  describe("Happy path", function() {
    it("Farmer should earn money", async function() {
      ...
      for (let i = 0; i < hours; i++) {
        ...
        lpPrice = new BigNumber(2409758.21).times(D18);
