...
const Strategy = artifacts.require("JarvisHodlStrategyV3Mainnet_2EUR_EURT");
...
describe("Mainnet Jarvis 2EUR-EURT HODL in LP - Update rewardPool", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0x70044e640D79c022020849811AeCd7c8a878eAB8";
  let vaultAddr = "0xF7Cbe177157031eA2d63399BeEFc027779585Bb8";
  let potPoolAddr = "0x1046bC2199fa009a19A2a0A04eF598991BA4523E";
  let hodlVaultAddr = "0xE17e6EfbD0064992D1E4e9a4641f30e40be208a0";

  let rewardPoolAddr = "0xa0044b58b1de085845aeA7BD3256a00EAb4145a2";
  let rewardTokenAddr = "0x5eF12a086B8A61C0f11a72b36b5EF451FA17f1f1";
  let rewardLPAddr = "0x68Fd822a2Bda3dB31fFfA68089696ea4e55A9D36";
  let pid = 4;
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0x2C3cc8e698890271c8141be9F6fD6243d56B39f1");
  ...
  describe("Happy path", function() {
    it("Farmer should earn money", async function() {
      ...
      for (let i = 0; i < hours; i++) {
        ...
        hodlPrice = new BigNumber(34716524).times(D18);
        lpPrice = new BigNumber(0.78).times(D18);
