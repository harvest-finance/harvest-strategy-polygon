...
const Strategy = artifacts.require("JarvisHodlStrategyV3Mainnet_jGBP_USDC");
...
describe("Mainnet Jarvis jGBP-USDC HODL in LP V3", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0xb82d8A3c2956adcB4F98De2f4d58E99196b4Ba81";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0xbb2d00675B775E0F8acd590e08DA081B2a36D3a6");
  ...
  before(async function() {
    ...
    [controller, vault, strategy, potPool] = await setupCoreProtocol({
      "existingVaultAddress": "0xe94D89243a7Aeaf88857461ce555caEB344765Fc",
      "existingRewardPoolAddress": "0x877635e68C1E943D6d6B777C0e847Cd7aE5A01BE",
  ...
  describe("Happy path", function() {
    it("Farmer should earn money", async function() {
      ...
      for (let i = 0; i < hours; i++) {
        ...
        lpPrice = new BigNumber(2370849).times(D18);
