...
describe("Mainnet Jarvis 2NZD HODL in LP - Update rewardPool", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0x94ED7191a275238030083F7a18fC95ab71408588";
  let vaultAddr = "0x6F2047E88D70fEcEbA2D33Ec6A0CC579B56CEa52";
  let potPoolAddr = "0xfcD319Da00C632c2Fca0c95E147A5494973E6fC8";
  ...
  describe("Happy path", function() {
    it("Farmer should earn money", async function() {
      ...
      for (let i = 0; i < hours; i++) {
        ...
        lpPrice = new BigNumber(0.62).times(D18);
