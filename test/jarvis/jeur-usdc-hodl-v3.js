...
const HodlStrategy = artifacts.require("JarvisStrategyV3Mainnet_AUR3_USDC");
const Strategy = artifacts.require("JarvisHodlStrategyV3Mainnet_jEUR_USDC");

const D18 = new BigNumber(Math.pow(10, 18));

//This test was developed at blockNumber 24775750

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Mainnet Jarvis jEUR-USDC HODL in LP V3", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0xA93d4288758bE21D22D24924AAFd3e3922277B9C";
  let hodlUnderlying = "0xF40E249737c510CCE832286e54cB30E60D4e4656";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0xa1219DBE76eEcBf7571Fed6b020Dd9154396B70e");
  ...
  before(async function() {
    ...
    [controller, vault, strategy, potPool] = await setupCoreProtocol({
      "existingVaultAddress": "0xA832926e3F6A3339ae68f70d76860D212959E0E7",
      "existingRewardPoolAddress": "0xf25474FBf9812bE2ef76abf4297A27411C156403",
    ...
    await potPool.addRewardToken(hodlVault.address, {from: governance});
  ...
  describe("Happy path", function() {
    it("Farmer should earn money", async function() {
      ...
      for (let i = 0; i < hours; i++) {
        ...
        hodlPrice = new BigNumber(83773585).times(D18);
        lpPrice = new BigNumber(2014925).times(D18);
