...
const Strategy = artifacts.require("JarvisHodlStrategyMainnet_jEUR_USDC");
...
describe("Mainnet Jarvis jEUR-USDC HODL in LP", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0x1bCD6e50cB2e89f73235621f5Eaa819D6f60de07";
  ...
  describe("Happy path", function() {
    it("Farmer should earn money", async function() {
      ...
      for (let i = 0; i < hours; i++) {
        ...
        lpPrice = new BigNumber(2148454.25).times(D18);
