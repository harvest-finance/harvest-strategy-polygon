...
const Strategy = artifacts.require("JarvisStrategyV3Mainnet_agDEN_2EUR");

//This test was developed at blockNumber 28466500

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Mainnet Jarvis agDEN-2EUR", function() {
  let accounts;
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0x7d85cCf1B7cbAAB68c580E14fA8C92E32704404f");
