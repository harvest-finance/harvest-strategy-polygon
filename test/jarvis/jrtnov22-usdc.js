...
const Strategy = artifacts.require("JarvisStrategyV3Mainnet_JRTNOV22_USDC");

//This test was developed at blockNumber 33304250

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Mainnet Jarvis JRTNOV22-USDC", function() {
  let accounts;
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0x68Fd822a2Bda3dB31fFfA68089696ea4e55A9D36");
