...
const Strategy = artifacts.require("JarvisStrategyV3Mainnet_AURJUL22_WETH");

//This test was developed at blockNumber 28954000

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Mainnet Jarvis AUR(JUL22)-WETH", function() {
  let accounts;
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0xF9Ce68A9E41f1e7cee5FDCbef99669653Aa61390");
