...
const Strategy = artifacts.require("PopsicleStrategtMainnet_ICE_WETH");
const FeeRewardForwarder = artifacts.require("FeeRewardForwarder");

//This test was developed at blockNumber 23558000

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Mainnet Popsicle ICE-WETH", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0x6ac1D04277d119a748703C423c17DCB2bbAb1B67";
  ...
  let ice = "0x4e1581f01046eFDd7a1a2CDB0F82cdd7F71F2E59";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0x941eb28e750C441AEF465a89E43DDfec2561830b");
