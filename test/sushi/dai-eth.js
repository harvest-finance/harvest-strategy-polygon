...
const Strategy = artifacts.require("SushiStrategyMainnet_DAI_ETH");

const sushiRouterAddress = "0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506";

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Polygon Mainnet Sushiswap DAI/ETH", function() {
  let accounts;
  ...
  let token1Addr = "0x7ceB23fD6bC0adD59E62ac25578270cFf1b9f619"; //weth
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0x6FF62bfb8c12109E8000935A6De54daD83a4f39f");
  ...
  async function setupBalance(){
    ...
    await swapMaticToToken (
      farmer1,
      [addresses.WMATIC, token1.address, token0.address],
