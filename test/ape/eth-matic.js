...
const Strategy = artifacts.require("ApeStrategyMainnet_ETH_MATIC");
const FeeRewardForwarder = artifacts.require("FeeRewardForwarder");

const apeRouterAddress = "0xC0788A3aD43d79aa53B09c2EaCc313A787d1d607";

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Polygon Mainnet ApeSwap ETH/MATIC", function() {
  let accounts;
  ...
  // external setup
  let token0Addr = "0x7ceB23fD6bC0adD59E62ac25578270cFf1b9f619"; //weth
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0x6Cf8654e85AB489cA7e70189046D507ebA233613"); //eth-matic
  ...
  before(async function() {
    ...
    let path = [banana, token1Addr, token0Addr];
