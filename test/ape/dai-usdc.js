...
const Strategy = artifacts.require("ApeStrategyMainnet_DAI_USDC");
const FeeRewardForwarder = artifacts.require("FeeRewardForwarder");

const apeRouterAddress = "0xC0788A3aD43d79aa53B09c2EaCc313A787d1d607";

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Polygon Mainnet ApeSwap DAI/USDC", function() {
  let accounts;
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0x5b13B583D4317aB15186Ed660A1E4C65C10da659"); //dai-usdc
