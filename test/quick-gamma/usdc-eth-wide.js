...
const Strategy = artifacts.require("QuickGammaStrategyMainnet_USDC_ETH_wide");

//This test was developed at blockNumber 39013300

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Mainnet Quickswap-Gamma USDC-ETH (wide)", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0xCB6222f4Df04385ea08E8DA2A5871131FF5F6cBA";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0x6077177d4c41E114780D9901C9b5c784841C523f");
