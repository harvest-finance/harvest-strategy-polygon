...
const Strategy = artifacts.require("QuickGammaStrategyMainnet_MATIC_ETH_wide");

//This test was developed at blockNumber 39013300

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Mainnet Quickswap-Gamma MATIC-ETH (wide)", function() {
  let accounts;
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0x81Cec323BF8C4164c66ec066F53cc053A535f03D");
