...
const Strategy = artifacts.require("ComplifiStrategyMainnet_COMP5x");
...
describe("Complifi: COMP5x", function() {
  let accounts;
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0x8716637bc05dBAFE19B9C47Fb238095C297405b7");
